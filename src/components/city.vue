...
<van-grid>
  ...
  <!-- <van-index-anchor v-for="(item, index) in delFirsts" :key="index">{{item.prefix.toLocaleUpperCase()}}</van-index-anchor> -->
    ...
    <van-cell v-for="item in cellList[1]" :key="item" :title="item"/>
    <van-index-anchor index="2">C</van-index-anchor>
    <van-cell v-for="item in cellList[2]" :key="item" :title="item"/>
     <van-index-anchor index="2">D</van-index-anchor>
    <van-cell v-for="item in cellList[3]" :key="item" :title="item"/>
     <van-index-anchor index="2">E</van-index-anchor>
    <van-cell v-for="item in cellList[4]" :key="item" :title="item"/>
     <van-index-anchor index="2">F</van-index-anchor>
    <van-cell v-for="item in cellList[5]" :key="item" :title="item"/>
     <van-index-anchor index="2">G</van-index-anchor>
    <van-cell v-for="item in cellList[6]" :key="item" :title="item"/>
     <van-index-anchor index="2">H</van-index-anchor>
    <van-cell v-for="item in cellList[7]" :key="item" :title="item"/>
     <van-index-anchor index="2">J</van-index-anchor>
    <van-cell v-for="item in cellList[8]" :key="item" :title="item"/>
     <van-index-anchor index="2">K</van-index-anchor>
    <van-cell v-for="item in cellList[9]" :key="item" :title="item"/>
     <van-index-anchor index="2">L</van-index-anchor>
    <van-cell v-for="item in cellList[10]" :key="item" :title="item"/>
     <van-index-anchor index="2">M</van-index-anchor>
    <van-cell v-for="item in cellList[11]" :key="item" :title="item"/>
     <van-index-anchor index="2">N</van-index-anchor>
    <van-cell v-for="item in cellList[12]" :key="item" :title="item"/>
      <van-index-anchor index="2">P</van-index-anchor>
    <van-cell v-for="item in cellList[13]" :key="item" :title="item"/>
      <van-index-anchor index="2">Q</van-index-anchor>
    <van-cell v-for="item in cellList[14]" :key="item" :title="item"/>
      <van-index-anchor index="2">R</van-index-anchor>
    <van-cell v-for="item in cellList[15]" :key="item" :title="item"/>
      <van-index-anchor index="2">S</van-index-anchor>
    <van-cell v-for="item in cellList[16]" :key="item" :title="item"/>
      <van-index-anchor index="2">T</van-index-anchor>
    <van-cell v-for="item in cellList[17]" :key="item" :title="item"/>
